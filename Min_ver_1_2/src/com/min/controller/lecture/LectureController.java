...
public class LectureController {
	...
	@Autowired
	private LectureService lectureSerivce;
	...
	public ModelAndView selectAll( HttpServletRequest req ){
		//System.out.println((String)req.getParameter("lecturecategory_id"));
		int lecturecategory_id = Integer.parseInt(req.getParameter("lecturecategory_id"));
		//System.out.println(lecturecategory_id);
		List<Lecture> list = lectureSerivce.selectAll(lecturecategory_id);
		LectureCategory lectureCategory = lectureSerivce.getLectureCategory(lecturecategory_id);
	...
	public ModelAndView selectOne( HttpServletRequest req ){
		...
		Lecture lecture = lectureSerivce.select(lecture_id);
