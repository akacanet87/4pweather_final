	...
	<table id="box" align="center" width="603" border="0" cellpadding="0"
		...
		<tr>
			<td height="30" align="right" style="padding-right: 2px;"><img
				src="/images/write_btin.gif" width="61" height="20" onClick="edit()"> <img
				src="/images/delete_btn.gif" width="61" height="20" onClick="del()">
				<a href="list.jsp"><img src="/images/list_btn.gif" width="61"
