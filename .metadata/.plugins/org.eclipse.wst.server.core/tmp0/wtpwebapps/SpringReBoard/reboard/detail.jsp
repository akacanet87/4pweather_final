...
function showForm(){
	...
	if(replyArea.style.display=="none"){//않보이고 있다면...
		replyArea.style.display="block";
	}else{//이미 보이고 있다면, 전송하자!
...
<table id="box" align="center" width="603" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<img src="/images/delete_btn.gif" width="61" height="20"> 
	<a href="list.jsp"><img src="/images/list_btn.gif" width="61" height="20" border="0"></a> </td>
  </tr>
  <tr>
    <td height="1" bgcolor="#CCCCCC"></td>
  </tr>
