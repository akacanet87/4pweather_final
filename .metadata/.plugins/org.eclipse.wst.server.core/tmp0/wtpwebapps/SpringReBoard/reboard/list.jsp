	...
	<table id="box" align="center" width="603" border="0" cellpadding="0"
			...
			<td colspan="5" id="list">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<tr align="center" height="20px"
						...
						<td width="50"><%=num--%></td>
						<td width="303"><a
							href="/reboard/detail.do?reboard_id=<%=board.getReboard_id()%>"><%=board.getTitle()%></a></td>
			...
			<td height="20" colspan="5" align="right" style="padding-right: 2px;">
				<table width="160" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><img src="/images/search_btn.gif" width="32"
							height="17"></td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td height="30" colspan="5" align="right" style="padding-right: 2px;"><a
				href="write.jsp"><img src="/images/write_btin.gif"
