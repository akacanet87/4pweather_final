 ...
 * Generated at: 2016-11-04 04:30:42 UTC
...
public final class lecture_005finsert_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	List listLecCat = (List)request.getAttribute("list");
      ...
      out.write("\t\t\t\t\t<form role=\"form\" name=\"lectureForm\">\r\n");
...
for(int i=listLecCat.size()-1; i>=0; --i){
 ...
 LectureCategory lectureCategory = (LectureCategory)listLecCat.get(i);
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"title\" name=\"title\" placeholder=\"제목을 입력해주세요\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\" id=\"lec_content\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"content\">설명</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t<textarea class=\"form-control\" rows=\"3\" id=\"content\" name=\"content\" placeholder=\"강의 설명을 입력주세요\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" id=\"link\" name=\"link\" placeholder=\"강의 동영상 URL을 입력주세요\" style=\"height:34px; font-size: 14px; border-radius:0;\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<label for=\"thumbnail\">썸네일 이미지</label> <input type=\"text\" class=\"form-control\" id=\"thumbnail\" name=\"thumbnail\" placeholder=\"동영상 URL 확인 시 자동으로 입력됩니다.\" readonly>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\" id=\"lec_lecturefile\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"lectureSlideFile\">강의자료</label> <input type=\"file\" id=\"lectureSlideFile\" name=\"lectureSlideFile\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\" id=\"lec_homework\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"homeworkFile\">과제</label> <input type=\"file\" id=\"homeworkFile\" name=\"homeworkFile\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<!-- /.box-body -->\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<div class=\"box-footer\">\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-primary\" id=\"lec_btn\" disabled=\"disabled\" onClick=\"addLecture()\">추가</button>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- /.box -->\r\n");
